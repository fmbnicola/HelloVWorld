	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( lerpResult11 * _Alpha ) + saturate( ( ( ( saturate( ( 1.0 - step( ( 1.0 - abs( temp_output_26_0 ) ) , ( 1.0 - _MainStreakWidth ) ) ) ) + saturate( ( step( temp_output_26_0 , ( _SecondStreakOffset + temp_output_55_0 ) ) * ( 1.0 - step( temp_output_26_0 , ( _SecondStreakOffset - temp_output_55_0 ) ) ) ) ) ) * _StreakColor ) * ( pow( saferPower73 , _GlarePower ) * _GlareIntensity ) ) ) + ( clampResult102 * _Color0 ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18600
422;157;1159;914;997.6564;465.9382;1.966514;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-2636.915,294.5248;Inherit;False;2;2;0;FLOAT3x3;0,0,0,1,1,1,1,0,1;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;104;694.198,900.616;Inherit;False;Property;_Color0;Color 0;11;0;Create;True;0;0;False;0;False;0.003960493,0.6721381,0.8396226,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-21.76249,666.2724;Inherit;False;Property;_Distance;Distance;10;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DotProductOpNode;67;-1106.882,1347.316;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;-548.0738,264.4057;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.PowerNode;73;-850.8618,1347.908;Inherit;True;True;2;0;FLOAT;0;False;1;FLOAT;5.34;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-1978.625,173.7307;Inherit;False;Property;_MainStreakWidth;MainStreakWidth;5;0;Create;True;0;0;False;0;False;0.3;0.633;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-1455.274,-322.2271;Inherit;False;Property;_FresnelStrength;Fresnel Strength;4;0;Create;True;0;0;False;0;False;1;5.01;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-2790.095,795.8297;Inherit;False;Property;_SecondStreakWidth;SecondStreakWidth;6;0;Create;True;0;0;False;0;False;0.2;0.35;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;106;96.25189,253.9481;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;103;1026.92,712.5287;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=A2B2F5453F90945EA119E0A29713B53AAF01C541