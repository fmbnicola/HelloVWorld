...
Shader "FloorTileShader"
{
	Properties
	{
		...
		_FloorTileTexture("FloorTileTexture", 2D) = "white" {}
		_NormalStrength("NormalStrength", Float) = 0.8
		_NoiseImpact("NoiseImpact", Range( 0 , 1)) = 0
		_NoiseScale("NoiseScale", Range( 0 , 10)) = 6
		[ASEEnd]_NoiseVariation("NoiseVariation", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _FloorTileTexture_ST;
			float _NoiseScale;
			float _NoiseVariation;
			float _NoiseImpact;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_FloorTileTexture = IN.ase_texcoord7.xy * _FloorTileTexture_ST.xy + _FloorTileTexture_ST.zw;
				float time62 = _NoiseVariation;
				float2 coords62 = ( floor( uv_FloorTileTexture ) / _FloorTileTexture_ST.xy ) * _NoiseScale;
				float2 id62 = 0;
				float2 uv62 = 0;
				float voroi62 = voronoi62( coords62, time62, id62, uv62, 0 );
				
				float2 temp_output_2_0_g3 = uv_FloorTileTexture;
				...
				float4 tex2DNode14_g3 = tex2D( _FloorTileTexture, temp_output_2_0_g3 );
				float temp_output_4_0_g3 = _NormalStrength;
				float3 appendResult13_g3 = (float3(1.0 , 0.0 , ( ( tex2D( _FloorTileTexture, appendResult8_g3 ).g - tex2DNode14_g3.g ) * temp_output_4_0_g3 )));
				float2 appendResult9_g3 = (float2(break6_g3.x , ( break6_g3.y + temp_output_25_0_g3 )));
				float3 appendResult16_g3 = (float3(0.0 , 1.0 , ( ( tex2D( _FloorTileTexture, appendResult9_g3 ).g - tex2DNode14_g3.g ) * temp_output_4_0_g3 )));
				float3 normalizeResult22_g3 = normalize( cross( appendResult13_g3 , appendResult16_g3 ) );
				
				float3 Albedo = ( tex2D( _FloorTileTexture, uv_FloorTileTexture ) * (( 1.0 - _NoiseImpact ) + (voroi62 - 0.0) * (1.0 - ( 1.0 - _NoiseImpact )) / (1.0 - 0.0)) ).rgb;
				float3 Normal = normalizeResult22_g3;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_FloorTileTexture = IN.ase_texcoord2.xy * _FloorTileTexture_ST.xy + _FloorTileTexture_ST.zw;
				float time62 = _NoiseVariation;
				float2 coords62 = ( floor( uv_FloorTileTexture ) / _FloorTileTexture_ST.xy ) * _NoiseScale;
				float2 id62 = 0;
				float2 uv62 = 0;
...
/*ASEBEGIN
Version=18600
1920;0;1920;1019;2182.575;748.8907;1.836699;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;6;-1396.241,-57.58651;Inherit;False;0;7;2;3;2;SAMPLER2D;;False;0;FLOAT2;5,5;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;87;-1121.989,166.1999;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;7;-1408.969,-359.8385;Inherit;True;Property;_FloorTileTexture;FloorTileTexture;1;0;Create;True;0;0;False;0;False;dbf54e2178c97264da9449fecb190d6c;dbf54e2178c97264da9449fecb190d6c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.WireNode;93;-1094.465,191.6015;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;88;-1148.167,352.2587;Inherit;False;1;0;SAMPLER2D;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.TextureTransformNode;86;-868.2735,403.0984;Inherit;False;-1;False;1;0;SAMPLER2D;;False;2;FLOAT2;0;FLOAT2;1
Node;AmplifyShaderEditor.FloorOpNode;74;-859.6636,174.7543;Inherit;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;81;-534.4932,528.2849;Inherit;False;Property;_NoiseVariation;NoiseVariation;7;0;Create;True;0;0;False;0;False;0;-0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-629.3695,724.275;Inherit;False;Property;_NoiseImpact;NoiseImpact;5;0;Create;True;0;0;False;0;False;0;0.66;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;80;-629.5309,629.934;Inherit;False;Property;_NoiseScale;NoiseScale;6;0;Create;True;0;0;False;0;False;6;6;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;75;-564.4688,274.1106;Inherit;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;89;-1097.785,-76.69453;Inherit;False;1;0;SAMPLER2D;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.WireNode;90;-1065.025,-54.28606;Inherit;False;1;0;SAMPLER2D;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.OneMinusNode;79;-188.8596,728.3839;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;62;-283.4658,274.4186;Inherit;True;0;4;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0.24;False;2;FLOAT;6.06;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.SamplerNode;8;-363.095,-71.87204;Inherit;True;Property;_FloorTile;FloorTile;2;0;Create;True;0;0;False;0;False;-1;dbf54e2178c97264da9449fecb190d6c;dbf54e2178c97264da9449fecb190d6c;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCRemapNode;73;48.90781,274.8863;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;85;411.4507,340.3929;Inherit;False;Property;_Smoothness;Smoothness;0;0;Create;True;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;9;-338.8828,-353.912;Inherit;True;NormalCreate;2;;3;e12f7ae19d416b942820e3932b56220f;0;4;1;SAMPLER2D;;False;2;FLOAT2;0,0;False;3;FLOAT;0.5;False;4;FLOAT;2;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-541.1229,-235.6403;Inherit;False;Property;_NormalStrength;NormalStrength;4;0;Create;True;0;0;False;0;False;0.8;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;364.3131,-74.43588;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;91;-1102.586,-280.818;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;92;-1075.514,-299.7689;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
WireConnection;1;4;85;0
ASEEND*/
//CHKSM=10F3BD879FAF347FAC6B5F206E0051BC81193CFA