...
Shader "DoorShader"
{
	Properties
	{
		...
		[ASEEnd]_AnimationTime("AnimationTime", Range( 0 , 1)) = 0.88
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float _AnimationTime_Instance = UNITY_ACCESS_INSTANCED_PROP(DoorShader,_AnimationTime);
				float2 texCoord13 = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 appendResult14 = (float4(texCoord13.y , texCoord13.y , texCoord13.y , 0.0));
				float clampResult34 = clamp( (0.0 + (_AnimationTime_Instance - 0.0) * (9.0 - 0.0) / (1.0 - 0.0)) , 0.0 , ( ( 1.0 - appendResult14 ) * 9.0 ).x );
				float4 appendResult20 = (float4(0.0 , clampResult34 , 0.0 , 0.0));
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 _TextureSample0_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(DoorShader,_TextureSample0_ST);
...
/*ASEBEGIN
Version=18600
0;0;1280;739;1880.869;15.63803;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-2005.286,220.7727;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;14;-1753.239,268.7727;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-1422.303,525.7822;Inherit;False;Constant;_FinalOffset;FinalOffset;5;0;Create;True;0;0;False;0;False;9;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;30;-1451.435,265.86;Inherit;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-1495.501,76.95645;Inherit;False;InstancedProperty;_AnimationTime;AnimationTime;2;0;Create;True;0;0;False;0;False;0.88;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;36;-1165.565,85.00226;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;9;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-1180.169,266.6406;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ClampOpNode;34;-899.2681,217.4186;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;16;-586.6265,216.2033;Inherit;False;FLOAT;1;0;FLOAT;0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.RangedFloatNode;6;-312.8958,88.93705;Inherit;False;Property;_Smoothness;Smoothness;0;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;7;-366,-190.5;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;False;0;False;-1;11ac53c6a4772c749b54a3dc26559a4c;11ac53c6a4772c749b54a3dc26559a4c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;20;-342.1266,194.2033;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=4153F00E333C0AEAF543E69D38B4B1CD912F6FD6