...
Shader "ComparatorSymbolShader"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Comparator("Comparator", Range( 0 , 2)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _LessThan;
			UNITY_INSTANCING_BUFFER_START(ComparatorSymbolShader)
				...
				UNITY_DEFINE_INSTANCED_PROP(float, _Comparator)
			UNITY_INSTANCING_BUFFER_END(ComparatorSymbolShader)
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 _Equals_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(ComparatorSymbolShader,_Equals_ST);
				float2 uv_Equals = IN.ase_texcoord7.xy * _Equals_ST_Instance.xy + _Equals_ST_Instance.zw;
				float4 _NotEquals_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(ComparatorSymbolShader,_NotEquals_ST);
				float2 uv_NotEquals = IN.ase_texcoord7.xy * _NotEquals_ST_Instance.xy + _NotEquals_ST_Instance.zw;
				float _Comparator_Instance = UNITY_ACCESS_INSTANCED_PROP(ComparatorSymbolShader,_Comparator);
				float4 lerpResult28 = lerp( tex2D( _Equals, uv_Equals ) , tex2D( _NotEquals, uv_NotEquals ) , ( _Comparator_Instance == 1.0 ? 1.0 : 0.0 ));
				float4 _LessThan_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(ComparatorSymbolShader,_LessThan_ST);
				float2 uv_LessThan = IN.ase_texcoord7.xy * _LessThan_ST_Instance.xy + _LessThan_ST_Instance.zw;
				float4 lerpResult42 = lerp( lerpResult28 , tex2D( _LessThan, uv_LessThan ) , ( _Comparator_Instance == 2.0 ? 1.0 : 0.0 ));
...
/*ASEBEGIN
Version=18600
0;6;1266;733;1038.916;-356.9891;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;22;-457.0776,887.1467;Inherit;False;InstancedProperty;_Comparator;Comparator;0;0;Create;True;0;0;False;0;False;0;2;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;25;-929.7421,171.6191;Inherit;True;Property;_NotEquals;NotEquals;3;0;Create;True;0;0;False;0;False;-1;None;5d9446c09ed4a214bb03a800edb2eb8b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;18;-923.6343,-76.24682;Inherit;True;Property;_Equals;Equals;2;0;Create;True;0;0;False;0;False;-1;a96b52f3f2de5ba43a1b9e8bdc338db1;5d9446c09ed4a214bb03a800edb2eb8b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;43;-916.5161,433.6331;Inherit;True;Property;_LessThan;LessThan;4;0;Create;True;0;0;False;0;False;-1;None;5d9446c09ed4a214bb03a800edb2eb8b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;40;959.8294,787.4536;Inherit;False;Property;_Color0;Color 0;1;0;Create;True;0;0;False;0;False;0,0.9504251,0.9811321,0;1,1,1,0.9921569;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B0395091D0023A948DF7B1410F03763053437051