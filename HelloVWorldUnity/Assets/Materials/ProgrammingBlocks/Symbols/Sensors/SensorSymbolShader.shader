...
Shader "SensorSymbolShader"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Sensor("Sensor", Range( 0 , 1)) = 0
		_Color0("Color 0", Color) = (0,0,0,0)
		_Camera("Camera", 2D) = "white" {}
		[ASEEnd]_Microphone("Microphone", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			CBUFFER_END
			sampler2D _Camera;
			sampler2D _Microphone;
			UNITY_INSTANCING_BUFFER_START(SensorSymbolShader)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Camera_ST)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Microphone_ST)
				UNITY_DEFINE_INSTANCED_PROP(float, _Sensor)
			UNITY_INSTANCING_BUFFER_END(SensorSymbolShader)
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 _Camera_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SensorSymbolShader,_Camera_ST);
				float2 uv_Camera = IN.ase_texcoord7.xy * _Camera_ST_Instance.xy + _Camera_ST_Instance.zw;
				float4 _Microphone_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SensorSymbolShader,_Microphone_ST);
				float2 uv_Microphone = IN.ase_texcoord7.xy * _Microphone_ST_Instance.xy + _Microphone_ST_Instance.zw;
				float _Sensor_Instance = UNITY_ACCESS_INSTANCED_PROP(SensorSymbolShader,_Sensor);
				float4 lerpResult28 = lerp( tex2D( _Camera, uv_Camera ) , tex2D( _Microphone, uv_Microphone ) , _Sensor_Instance);
				float4 temp_output_39_0 = ( _Color0 * lerpResult28.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 _Camera_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SensorSymbolShader,_Camera_ST);
				float2 uv_Camera = IN.ase_texcoord2.xy * _Camera_ST_Instance.xy + _Camera_ST_Instance.zw;
				float4 _Microphone_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(SensorSymbolShader,_Microphone_ST);
				float2 uv_Microphone = IN.ase_texcoord2.xy * _Microphone_ST_Instance.xy + _Microphone_ST_Instance.zw;
				float _Sensor_Instance = UNITY_ACCESS_INSTANCED_PROP(SensorSymbolShader,_Sensor);
				float4 lerpResult28 = lerp( tex2D( _Camera, uv_Camera ) , tex2D( _Microphone, uv_Microphone ) , _Sensor_Instance);
...
/*ASEBEGIN
Version=18600
0;6;1266;733;1641.519;-52.04676;2.165109;True;False
Node;AmplifyShaderEditor.SamplerNode;25;-734.8757,775.8206;Inherit;True;Property;_Microphone;Microphone;3;0;Create;True;0;0;False;0;False;-1;None;1c35176bdd50afb48834a73946747e85;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;18;-736.7679,527.9548;Inherit;True;Property;_Camera;Camera;2;0;Create;True;0;0;False;0;False;-1;None;1c35176bdd50afb48834a73946747e85;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;41;-728.0176,997.5463;Inherit;False;InstancedProperty;_Sensor;Sensor;0;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;40;716.4994,518.1072;Inherit;False;Property;_Color0;Color 0;1;0;Create;True;0;0;False;0;False;0,0,0,0;0.6659297,0,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;38;703.5455,781.5479;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;962.4349,520.0434;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;13;1412.265,711.4234;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;SensorSymbolShader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=4EDD78039591E23242CAECB93FA715B1609A908E